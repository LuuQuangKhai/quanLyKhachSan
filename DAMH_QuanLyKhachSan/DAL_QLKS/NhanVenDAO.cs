    ...
    class NhanVienDAO
    {
            ...
            string DiaChi, int SDT, DateTime NgayVaoLam)
        {
            try
            {
                ...
                help.executeNonQuery("sp_InsertNhanVien '" + TenDangNhap + "', '" + TenNV + "','" + MatKhau + "','" + MaLoaiNV + "','" + CMND + "','" + NgaySinh + "','" + GioiTinh + "','" + DiaChi + "','" + SDT + "','" + NgayVaoLam + "'");
                return true;
            }
            catch (Exception ex)
            {
        ...
        public bool UpdateNhanVien(string TenDangNhap, string TenNV, string MaLoaiNV, string CMND, DateTime NgaySinh, string GioiTinh, string DiaChi, int SDT, DateTime NgayVaoLam)
        {
            try
            {
                help.executeNonQuery("sp_UpdateNhanVien'" + TenDangNhap + "', '" + TenNV + "','" + MaLoaiNV + "','" + CMND + "','" + NgaySinh + "','" + GioiTinh + "','" + DiaChi + "','" + SDT + "','" + NgayVaoLam + "' ");
                return true;
            }
            catch (Exception ex)
            {
